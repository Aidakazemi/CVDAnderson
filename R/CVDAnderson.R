#' Predicting Cardiovascular disease (CVD) risk based on ...
#'
#' @param gender A binary variable taking 1 if patient is female and 0 otherwise
#' @param age A number for age
#' @param Tchol A number for Total Cholesterol in mg/dL
#' @param HDLChol A number for HDL Cholesterol in mg/dL
#' @param SBP A number fo systolic blood pressure in mm Hg
#' @param DBP A number for diastolic blood pressure in mm Hg
#' @param diabetes A binary variable taking 1 if a casual whole blood glucose measurement was 150 mg/dl orabove or the individual was being treated with insulin or oral hypoglycemics (In case of having no information, it is 0)
#' @param smoker A binary variable taking 1 for person who smoked during the past 12 month and 0 therwise
#' @param ECG_LVH A binary variable taking 1 for patients diagnosed with ECG-left ventricular hypertrophy and 0 otherwise (In case of having no information, it is 0)
